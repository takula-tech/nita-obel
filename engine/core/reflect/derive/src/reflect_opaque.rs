use crate::{
    attr::container::ContainerAttributes, derive_data::ReflectTraitToImpl, type_path::CustomPathDef,
};
...
pub(crate) struct ReflectOpaqueDef {
    #[cfg_attr(
        ...
        expect(dead_code, reason = "The is used when the `documentation` feature is enabled.",)
    )]
