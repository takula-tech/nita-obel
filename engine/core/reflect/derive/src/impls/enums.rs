...
pub(crate) fn impl_enum(reflect_enum: &ReflectEnum) -> proc_macro2::TokenStream {
    let obel_reflect_path = reflect_enum.meta().obel_reflect_path();
    ...
    let typed_impl =
        impl_typed(reflect_enum.meta(), &where_clause_options, reflect_enum.to_info_tokens());
    ...
    quote! {
        ...
        impl #impl_generics #obel_reflect_path::Enum for #enum_path #ty_generics #where_reflect_clause {
            fn field(&self, #ref_name: &str) -> #FQOption<&dyn #obel_reflect_path::PartialReflect> {
                 match #match_this {
                    #(#enum_field,)*
                    _ => #FQOption::None,
                }
            ...
            fn field_at(&self, #ref_index: usize) -> #FQOption<&dyn #obel_reflect_path::PartialReflect> {
                match #match_this {
                    #(#enum_field_at,)*
                    _ => #FQOption::None,
                }
            ...
            fn field_mut(&mut self, #ref_name: &str) -> #FQOption<&mut dyn #obel_reflect_path::PartialReflect> {
            ...
            fn field_at_mut(&mut self, #ref_index: usize) -> #FQOption<&mut dyn #obel_reflect_path::PartialReflect> {
                match #match_this_mut {
                    #(#enum_field_at_mut,)*
                    _ => #FQOption::None,
                }
            ...
            fn iter_fields(&self) -> #obel_reflect_path::VariantFieldIter {
                #obel_reflect_path::VariantFieldIter::new(self)
            }
            ...
            #[inline]
            fn variant_type(&self) -> #obel_reflect_path::VariantType {
                 match #match_this {
                    #(#enum_variant_type,)*
                    _ => unreachable!(),
                }
        ...
        impl #impl_generics #obel_reflect_path::PartialReflect for #enum_path #ty_generics #where_reflect_clause {
            #[inline]
            ...
            fn try_apply(
                &mut self,
                #ref_value: &dyn #obel_reflect_path::PartialReflect
            ) -> #FQResult<(), #obel_reflect_path::ApplyError>  {
                if let #obel_reflect_path::ReflectRef::Enum(#ref_value) =
                    #obel_reflect_path::PartialReflect::reflect_ref(#ref_value) {
                    if #obel_reflect_path::Enum::variant_name(self) == #obel_reflect_path::Enum::variant_name(#ref_value) {
                        // Same variant -> just update fields
                        match #obel_reflect_path::Enum::variant_type(#ref_value) {
                            #obel_reflect_path::VariantType::Struct => {
                                for field in #obel_reflect_path::Enum::iter_fields(#ref_value) {
                                    let name = field.name().unwrap();
                                    if let #FQOption::Some(v) = #obel_reflect_path::Enum::field_mut(self, name) {
                                       #obel_reflect_path::PartialReflect::try_apply(v, field.value())?;
                                    }
                                }
                            }
                            #obel_reflect_path::VariantType::Tuple => {
                                for (index, field) in ::core::iter::Iterator::enumerate(#obel_reflect_path::Enum::iter_fields(#ref_value)) {
                                    if let #FQOption::Some(v) = #obel_reflect_path::Enum::field_at_mut(self, index) {
                                        #obel_reflect_path::PartialReflect::try_apply(v, field.value())?;
                                    }
                                }
                            }
                        ...
                        match #obel_reflect_path::Enum::variant_name(#ref_value) {
                            #(#variant_names => {
                                #deref_this = #variant_constructors
                            })*
                            name => {
                                return #FQResult::Err(
                                    #obel_reflect_path::ApplyError::UnknownVariant {
                                        enum_name: ::core::convert::Into::into(#obel_reflect_path::DynamicTypePath::reflect_type_path(self)),
                    ...
                    return #FQResult::Err(
                        #obel_reflect_path::ApplyError::MismatchedKinds {
                            from_kind: #obel_reflect_path::PartialReflect::reflect_kind(#ref_value),
                            to_kind: #obel_reflect_path::ReflectKind::Enum,
                        }
                    );
                }
                #FQResult::Ok(())
...
fn generate_impls(reflect_enum: &ReflectEnum, ref_index: &Ident, ref_name: &Ident) -> EnumImpls {
    ...
    for (variant_index, variant) in reflect_enum.variants().iter().enumerate() {
        ...
        enum_variant_type.push(quote! {
            #unit{..} => #obel_reflect_path::VariantType::#variant_type_ident
        });
        ...
        fn process_field_value(
            ...
            field
                ...
                .remote
                .as_ref()
                .map(|ty| quote!(<#ty as #obel_reflect_path::ReflectRemote>::#method(#ident)))
        ...
        match &variant.fields {
            ...
            EnumVariantFields::Unnamed(fields) => {
                let field_len = process_fields(fields, |field: &StructField| {
                    ...
                    let value_ref = process_field_value(&__value, field, false, obel_reflect_path);
