...
pub(crate) fn impl_struct(reflect_struct: &ReflectStruct) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        impl #impl_generics #obel_reflect_path::Struct for #struct_path #ty_generics #where_reflect_clause {
            fn field(&self, name: &str) -> #FQOption<&dyn #obel_reflect_path::PartialReflect> {
                match name {
            ...
            fn field_mut(&mut self, name: &str) -> #FQOption<&mut dyn #obel_reflect_path::PartialReflect> {
                match name {
            ...
            fn field_at(&self, index: usize) -> #FQOption<&dyn #obel_reflect_path::PartialReflect> {
                match index {
            ...
            fn field_at_mut(&mut self, index: usize) -> #FQOption<&mut dyn #obel_reflect_path::PartialReflect> {
                match index {
            ...
            fn iter_fields(&self) -> #obel_reflect_path::FieldIter {
                #obel_reflect_path::FieldIter::new(self)
            }

            fn clone_dynamic(&self) -> #obel_reflect_path::DynamicStruct {
                let mut dynamic: #obel_reflect_path::DynamicStruct = #FQDefault::default();
                dynamic.set_represented_type(#obel_reflect_path::PartialReflect::get_represented_type_info(self));
                #(dynamic.insert_boxed(#field_names, #obel_reflect_path::PartialReflect::clone_value(#fields_ref));)*
                dynamic
            }
        }
        ...
        impl #impl_generics #obel_reflect_path::PartialReflect for #struct_path #ty_generics #where_reflect_clause {
            ...
            fn clone_value(&self) -> #obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #obel_reflect_path::PartialReflect> {
                #obel_reflect_path::__macro_exports::alloc_utils::Box::new(#obel_reflect_path::Struct::clone_dynamic(self))
            }
            ...
            fn try_apply(
                ...
                if let #obel_reflect_path::ReflectRef::Struct(struct_value)
                    = #obel_reflect_path::PartialReflect::reflect_ref(value) {
                    for (i, value) in ::core::iter::Iterator::enumerate(#obel_reflect_path::Struct::iter_fields(struct_value)) {
                        let name = #obel_reflect_path::Struct::name_at(struct_value, i).unwrap();
                        if let #FQOption::Some(v) = #obel_reflect_path::Struct::field_mut(self, name) {
                    ...
                    return #FQResult::Err(
                        #obel_reflect_path::ApplyError::MismatchedKinds {
                            ...
                            to_kind: #obel_reflect_path::ReflectKind::Struct
                        }
                    );
                }
                #FQResult::Ok(())
