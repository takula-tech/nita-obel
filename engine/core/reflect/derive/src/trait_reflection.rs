use obel_platform::string::{format, ToString};
use obel_reflect_utils::{FQClone, FQOption, FQResult, ObelManifest};
...
pub(crate) fn reflect_trait(_args: &TokenStream, input: TokenStream) -> TokenStream {
    ...
    let bevy_reflect_path = ObelManifest::shared().get_path("bevy_reflect");
