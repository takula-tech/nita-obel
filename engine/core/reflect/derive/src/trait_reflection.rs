...
pub(crate) fn reflect_trait(_args: &TokenStream, input: TokenStream) -> TokenStream {
    ...
    TokenStream::from(quote! {
        ...
        #trait_vis struct #reflect_trait_ident {
            get_func: fn(&dyn #obel_reflect_path::Reflect) -> #FQOption<&dyn #trait_ident>,
            get_mut_func: fn(&mut dyn #obel_reflect_path::Reflect) -> #FQOption<&mut dyn #trait_ident>,
            get_boxed_func: fn(#obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #obel_reflect_path::Reflect>) -> #FQResult<#obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #trait_ident>, #obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #obel_reflect_path::Reflect>>,
        }

        impl #reflect_trait_ident {
            #[doc = #get_doc]
            pub fn get<'a>(&self, reflect_value: &'a dyn #obel_reflect_path::Reflect) -> #FQOption<&'a dyn #trait_ident> {
                (self.get_func)(reflect_value)
            }

            #[doc = #get_mut_doc]
            pub fn get_mut<'a>(&self, reflect_value: &'a mut dyn #obel_reflect_path::Reflect) -> #FQOption<&'a mut dyn #trait_ident> {
                (self.get_mut_func)(reflect_value)
            }

            #[doc = #get_box_doc]
            pub fn get_boxed(&self, reflect_value: #obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #obel_reflect_path::Reflect>) -> #FQResult<#obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #trait_ident>, #obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #obel_reflect_path::Reflect>> {
                (self.get_boxed_func)(reflect_value)
            }
        }

        impl<T: #trait_ident + #obel_reflect_path::Reflect> #obel_reflect_path::FromType<T> for #reflect_trait_ident {
            fn from_type() -> Self {
                Self {
                    get_func: |reflect_value| {
                        <dyn #obel_reflect_path::Reflect>::downcast_ref::<T>(reflect_value).map(|value| value as &dyn #trait_ident)
                    },
                    get_mut_func: |reflect_value| {
                        <dyn #obel_reflect_path::Reflect>::downcast_mut::<T>(reflect_value).map(|value| value as &mut dyn #trait_ident)
                    },
                    get_boxed_func: |reflect_value| {
                        <dyn #obel_reflect_path::Reflect>::downcast::<T>(reflect_value).map(|value| value as #obel_reflect_path::__macro_exports::alloc_utils::Box<dyn #trait_ident>)
                    }
                }
            }
        }
