...
/// The foundational trait of [`obel_reflect`], used for accessing and modifying data dynamically.
///
...
///
/// [`obel_reflect`]: crate
/// [the derive macro for `Reflect`]: obel_reflect_derive::Reflect
/// [`Struct`]: crate::Struct
...
/// A core trait of [`obel_reflect`], used for downcasting to concrete types.
///
...
///
/// [`obel_reflect`]: crate
/// [the derive macro]: obel_reflect_derive::Reflect
/// [`Struct`]: crate::Struct
/// [`TupleStruct`]: crate::TupleStruct
/// [`Enum`]: crate::Enum
...
impl dyn PartialReflect {
    ...
    pub fn represents<T: Reflect + TypePath>(&self) -> bool {
        self.get_represented_type_info().is_some_and(|t| t.type_path() == T::type_path())
    }
    ...
    pub fn try_downcast<T: Any>(
        ...
        self.try_into_reflect()?.downcast().map_err(PartialReflect::into_partial_reflect)
    }
...
impl TypePath for dyn PartialReflect {
    fn type_path() -> &'static str {
        "dyn obel_reflect::PartialReflect"
    }
