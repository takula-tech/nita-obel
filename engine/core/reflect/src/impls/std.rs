...
impl_reflect_opaque!(bool(Clone, Debug, Hash, PartialEq, Serialize, Deserialize, Default));
impl_reflect_opaque!(char(Clone, Debug, Hash, PartialEq, Serialize, Deserialize, Default));
...
impl_reflect_opaque!(u128(Clone, Debug, Hash, PartialEq, Serialize, Deserialize, Default));
impl_reflect_opaque!(usize(Clone, Debug, Hash, PartialEq, Serialize, Deserialize, Default));
...
impl_reflect_opaque!(i128(Clone, Debug, Hash, PartialEq, Serialize, Deserialize, Default));
impl_reflect_opaque!(isize(Clone, Debug, Hash, PartialEq, Serialize, Deserialize, Default));
...
impl_reflect_opaque!(::obel_platform::time::Instant(Clone, Debug, Hash, PartialEq));
...
impl_reflect_opaque!(::core::num::NonZeroU8(Clone, Debug, Hash, PartialEq, Serialize, Deserialize));
impl_reflect_opaque!(::core::num::NonZeroI8(Clone, Debug, Hash, PartialEq, Serialize, Deserialize));
...
impl_reflect_opaque!(::obel_platform::sync::Arc<T: Send + Sync + ?Sized>(Clone));
...
impl_reflect_opaque!(::std::ffi::OsString(Clone, Debug, Hash, PartialEq, Serialize, Deserialize));
    ...
    V: FromReflect + MaybeTyped + TypePath + GetTypeRegistration,
{
    ...
    fn reflect_clone(&self) -> Result<Box<dyn Reflect>, ReflectCloneError> {
        ...
        for (key, value) in self.iter() {
            let key =
                key.reflect_clone()?.take().map_err(|_| ReflectCloneError::FailedDowncast {
                    expected: Cow::Borrowed(<K as TypePath>::type_path()),
                    received: Cow::Owned(key.reflect_type_path().to_string()),
                })?;
            let value =
                value.reflect_clone()?.take().map_err(|_| ReflectCloneError::FailedDowncast {
                    expected: Cow::Borrowed(<V as TypePath>::type_path()),
                    received: Cow::Owned(value.reflect_type_path().to_string()),
                })?;
            map.insert(key, value);
