...
///
/// ```
/// # use obel_reflect::func::{ArgList, DynamicFunctionMut, FunctionInfo, IntoFunctionMut};
/// #
...
impl<'env> DynamicFunctionMut<'env> {
    ...
    ///
    /// ```
    /// # use obel_reflect::func::IntoFunctionMut;
    /// let mut total_i32 = 0;
    ...
    ///
    /// // Test `i32`:
    /// let args = obel_reflect::func::ArgList::new().with_owned(123_i32);
    /// func.call(args).unwrap();
    ///
    /// // Test `f32`:
    /// let args = obel_reflect::func::ArgList::new().with_owned(1.23_f32);
    /// func.call(args).unwrap();
    ///
    /// drop(func);
    ...
    ///
    /// ```
    /// # use obel_reflect::func::{IntoFunctionMut, ArgList};
    /// let mut total = 0;
