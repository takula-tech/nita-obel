...
///
/// ```
/// # use obel_reflect::func::{ArgValue, ArgList};
/// let foo = 123;
/// let bar = 456;
/// let mut baz = 789;
...
mod tests {
    ...
    fn should_push_arguments_in_order() {
        let args = ArgList::new().with_owned(123).with_owned(456).with_owned(789);
    ...
    fn should_take_args_in_order() {
        ...
        let mut args = ArgList::new().with_owned(a).with_ref(&b).with_ref(&c).with_mut(&mut d);
    ...
    fn should_reindex_on_push_after_take() {
        let mut args = ArgList::new().with_owned(123).with_owned(456).with_owned(789);
