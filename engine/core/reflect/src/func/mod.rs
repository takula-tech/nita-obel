...
//! # use obel_reflect::func::args::ArgList;
//! # use obel_reflect::func::{DynamicFunction, FunctionResult, IntoFunction, Return};
...
//!
//! ```
//! # use obel_reflect::func::{ArgList, FunctionRegistry};
//! fn add(a: i32, b: i32) -> i32 {
//!     a + b
//! }
//!
