...
mod tests {
    ...
    fn test_serialization_struct() {
        ...
        assert!(
            expected.reflect_partial_eq(deserialized.as_partial_reflect()).unwrap(),
    ...
    #[test]
    #[should_panic(
        expected = "cannot serialize dynamic value without represented type: `obel_reflect::DynamicStruct`"
    )]
    ...
    fn should_roundtrip_proxied_dynamic() {
        ...
        let value: DynamicStruct = TestStruct {
            a: 123,
            b: 456,
        }
        .to_dynamic_struct();
        ...
        let expected = r#"{"obel_reflect::serde::tests::TestStruct":(a:123,b:456)}"#;
    ...
    mod type_data {
        ...
        use obel_reflect_derive::reflect_trait;
        ...
        impl TypePath for dyn Enemy {
            fn type_path() -> &'static str {
                "dyn obel_reflect::serde::tests::type_data::Enemy"
            }
        ...
        impl<'de> DeserializeWithRegistry<'de> for EnemyList {
                ...
                D: Deserializer<'de>,
            {
                ...
                deserializer
                    .deserialize_seq(EnemyListVisitor {
                        registry,
                    })
                    .map(EnemyList)
            }
        ...
        fn should_serialize_with_serialize_with_registry() {
            ...
            let expected = r#"{"obel_reflect::serde::tests::type_data::Level":(name:"Level 1",enemies:[{"obel_reflect::serde::tests::type_data::Skeleton":(10)},{"obel_reflect::serde::tests::type_data::Zombie":(health:20,walk_speed:0.5)}])}"#;
        ...
        fn should_deserialize_with_deserialize_with_registry() {
            ...
            let input = r#"{"obel_reflect::serde::tests::type_data::Level":(name:"Level 1",enemies:[{"obel_reflect::serde::tests::type_data::Skeleton":(10)},{"obel_reflect::serde::tests::type_data::Zombie":(health:20,walk_speed:0.5)}])}"#;
