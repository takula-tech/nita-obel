...
/// ```
/// # use core::any::Any;
/// # use obel_reflect::{DynamicTypePath, NamedField, PartialReflect, Reflect, ReflectMut, ReflectOwned, ReflectRef, StructInfo, TypeInfo, TypePath, OpaqueInfo, ApplyError};
/// # use obel_reflect::utility::NonGenericTypeInfoCell;
/// use obel_reflect::Typed;
///
/// struct MyStruct {
///   foo: usize,
///   bar: (f32, f32)
...
///
/// ```
/// use obel_reflect::{Type, TypePath};
///
